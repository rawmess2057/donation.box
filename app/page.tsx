    ...
    <main className="bg-[#FFF9F0]">
        ...
        <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-2 gap-12 items-center">
          <div className="space-y-8">
            <h1 className="text-6xl md:text-7xl font-bold leading-tight text-gray-900">
              Rebuilding Hope,
              <br />
              <span className="text-[#C25D2E] font-serif">One Community</span>
              <br />
              at a Time
            </h1>
            ...
            <p className="text-xl text-gray-600 max-w-lg">
              ...
              sustainable crowdfunding and transparent devnet fundraising flows.
            </p>

            <div className="flex flex-wrap gap-4 pt-4">
              <Link
                href="/explore"
                className="bg-[#C25D2E] hover:bg-[#A14D25] text-white font-semibold text-lg px-10 py-4 rounded-2xl transition-all duration-300 shadow-lg shadow-orange-200"
              >
                Start Exploring
              </Link>
              ...
              <Link
                href="/impact"
                className="border-2 border-gray-300 hover:border-gray-400 text-gray-700 font-semibold text-lg px-10 py-4 rounded-2xl transition-all duration-300"
              >
                Learn Our Impact
              </Link>
            </div>
      ...
      <section className="px-4 pt-10 pb-12">
        <div className="max-w-7xl mx-auto bg-stone-200/80 rounded-3xl px-6 py-5 grid grid-cols-3 gap-4 text-center">
          ...
          <div>
            <p className="text-[#4f6b2f] text-4xl font-bold leading-none">Devnet</p>
            <p className="text-stone-600 text-xs md:text-sm uppercase tracking-wide mt-1">
              Ready to Test
            </p>
          </div>
